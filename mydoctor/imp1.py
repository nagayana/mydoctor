...
def call(data):
    classify1()
    cl1 = NaiveBayesClassifier(train1[:1000])
    classify5()
    cl2 = NaiveBayesClassifier(train5[:1000])
  ...
  #   data = ""
    ...
    print("Drugs::::::::::::::")
    print(drug_sent)
    result=[disease_sent,symp_sent,drug_sent]
    return result
    # return "Disease::::::::::::<br>"+disease_sent+"<br>Symptom::::::::::::\n"+symp_sent+"\n\nDrugs::::::::::::::\n"+drug_sent
...
test1=[]
def training1():
    with open(r"C:\Users\ABHIJEET KUMAR\Desktop\myProject\mydoctor\training_file_1gram.csv", "r", encoding='utf-8') as fp:
        rows = csv.reader(fp)
        for row in rows:
            tup = ()
            tup = (row[0], row[1])
...
def testing1():
    with open(r"C:\Users\ABHIJEET KUMAR\Desktop\myProject\mydoctor\gold_testing_1gram.csv", "r", encoding='utf-8') as fp:  # test the module
        rows1 = csv.reader(fp)
        for row in rows1:
            tup = ()
            tup = (row[0], row[1])
...
test5=[]
def training5():
    with open(r'C:\Users\ABHIJEET KUMAR\Desktop\myProject\mydoctor\training_file_5gram.csv','r',encoding='utf-8') as fp:
        rows=csv.reader(fp)
        for row in rows:
            tup=()
            tup=(row[0],row[1])
...
def testing5():
    with open(r'C:\Users\ABHIJEET KUMAR\Desktop\myProject\mydoctor\gold_testing_1gram.csv','r',encoding='utf-8') as fp:
        rows1=csv.reader(fp)
        for row in rows1:
            tup=()
            tup=(row[0],row[1])
